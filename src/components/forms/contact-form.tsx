  ...
  if (state.succeeded) {
    return (
      ...
      >
        ...
        >
          <CheckCircle size={32} weight="fill" className="text-slate-600" />
        </motion.div>
        <motion.p 
        ...
        >
          ...
          >
            ...
            <div className="relative">
              ...
              <input
                name="name"
                type="text"
                className="block w-full pl-10 px-1 py-2 mt-2  placeholder-gray-400 bg-white border border-gray-200  focus:outline-none focus:border-slate-600"
                required
                maxLength={50}
                placeholder="山田 太郎"
              />
          ...
          >
            ...
            <div className="relative">
              ...
              <textarea
                name="message"
                className="block w-full pl-10 px-1 py-1 mt-2  placeholder-gray-400 bg-white border border-gray-200  h-48 focus:outline-none focus:border-slate-600"
          ...
          <motion.button
            ...
            className={`group relative w-full px-5 py-3 mt-6 text-sm font-medium bg-gradient-to-r from-slate-600 via-slate-500 to-slate-600 text-white border border-slate-600 transition-all duration-300 flex items-center justify-center ${
        ...
        >
          ...
          >
            <div className="space-y-4">
              <div className="flex items-start">
                <User size={20} weight="light" className="text-slate-600 mr-3 mt-1" />
                <div>
              ...
              <div className="flex items-start">
                <Phone size={20} weight="light" className="text-slate-600 mr-3 mt-1" />
                <div>
              ...
              <div className="flex items-start">
                <EnvelopeSimple size={20} weight="light" className="text-slate-600 mr-3 mt-1" />
                <div>
              ...
              <div className="flex items-start">
                <ChatText size={20} weight="light" className="text-slate-600 mr-3 mt-1" />
                <div>
          ...
          >
            <button
              ...
              className="flex-1 px-5 py-3 text-sm font-medium bg-gradient-to-r from-slate-200 via-slate-100 to-slate-200 text-slate-600 border border-slate-200 transition-all duration-300 flex items-center justify-center hover:!opacity-60"
            >
            ...
            <button
              ...
              disabled={state.submitting || isRateLimited}
              className={`flex-1 px-5 py-3 text-sm font-medium bg-gradient-to-r from-slate-600 via-slate-500 to-slate-600 text-white border border-slate-600 transition-all duration-300 flex items-center justify-center ${
                isRateLimited ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'
              } hover:!opacity-60`}
            >
